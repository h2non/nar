...
var fs, tar, createGunzip, EventEmitter, ref$, next, isFile, addExtension, list, apply;
fs = require('fs');
tar = require('tar');
createGunzip = require('zlib').createGunzip;
EventEmitter = require('events').EventEmitter;
ref$ = require('./utils'), next = ref$.next, isFile = ref$.isFile, addExtension = ref$.addExtension;
