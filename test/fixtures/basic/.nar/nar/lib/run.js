...
var fw, join, extract, download, spawn, EventEmitter, ref$, next, tmpdir, read, has, rm, delimiter, isWin, isArray, replaceEnvVars, isUrl, handleExit, hooksKeys, run, apply, readNarJson, getHooks, isBinaryValid, exec, getCommandScript, parseCommand, cleanSpaces, setEnvironment, extendPath, slice$ = [].slice;
fw = require('fw');
...
ref$ = require('./utils'), next = ref$.next, tmpdir = ref$.tmpdir, read = ref$.read, has = ref$.has, rm = ref$.rm, delimiter = ref$.delimiter, isWin = ref$.isWin, isArray = ref$.isArray, replaceEnvVars = ref$.replaceEnvVars, isUrl = ref$.isUrl, handleExit = ref$.handleExit;
