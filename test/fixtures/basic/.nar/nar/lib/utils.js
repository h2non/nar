...
var fs, hu, path, crypto, status, os, rm, mk, findup, normalize, join, basename, delimiter, extname, env, platform, exit, nextTick, arch, _;
fs = require('fs');
hu = require('hu');
path = require('path');
...
normalize = path.normalize, join = path.join, basename = path.basename, delimiter = path.delimiter, extname = path.extname;
