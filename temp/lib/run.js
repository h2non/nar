...
var fw, join, utils, extract, download, spawn, EventEmitter, next, tmpdir, read, has, rm, delimiter, isWin, isArray, replaceEnvVars, isUrl, handleExit, hooksKeys, regexQuotes, regexSpaces, run, apply, readNarJson, getHooks, isBinaryValid, exec, getCommandScript, parseCommand, parseFlags, cleanSpaces, setEnvironment, extendPath, slice$ = [].slice;
fw = require('fw');
