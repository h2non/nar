...
var fs, fw, path, pack, resolve, EventEmitter, dirname, basename, join, normalize, ref$, read, rm, tmpdir, clone, extend, copy, keys, archiveName, isObject, isFile, isDir, isString, mk, stringify, vals, exists, checksum, lines, next, isArray, now, replaceEnvVars, discoverPkg, narFile, ext, ignoredFiles, ignoreFiles, defaults, create, writeConfig, narManifest, includeFilesPatterns, getIgnoredFiles, isValid, outputFile, getFilename, applyPkgOptions, apply, resolvePkgPath, getBinaryPath, getModulePath, matchDependencies;
fs = require('fs');
fw = require('fw');
path = require('path');
pack = require('./pack');
...
module.exports = create = function(options){
  var errored, emitter, pkgPath, pkg, name, tmpPath, baseDir, file, output, clean, cleanError, onError, onEntry, onEnd, doCreate, compressAll, compressPkg, compressDependencies;
  errored = false;
  ...
  doCreate = function(){
    return next(function(){
      var narConfig, deps, basePkg, all, doCompression, onCompress, e;
